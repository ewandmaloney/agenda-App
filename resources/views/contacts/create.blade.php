        ...
        <div class="card">
          ...
          <div class="card-body">
            <form method="POST" action="{{ route('contacts.store') }}" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                <label for="company_id" class="col-md-4 col-form-label text-md-end">Company ID</label>
                <div class="col-md-6">
                  <select name="company_id" id="company_id" class="form-select">
                    @foreach ($companies as $company)
                      <option class="form-control @error('company_id') is-invalid @enderror" value="{{ $company->id }}">{{ $company->name }}</option>
                    @endforeach
                  </select>
                  @error('company_id')
                    <span class="invalid-feedback" role="alert">
              ...
              <div class="row mb-0">
                <div class="col-md-6 offset-md-4">
                  ...
                  <a class="btn btn-success ms-2" href="{{ route('company.create') }}">Don't see your company? Create here!</a>
                </div>
              </div>
            </form>
          </div>
